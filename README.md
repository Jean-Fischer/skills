...
This repository contains reusable local Pi skills.
...
- `angular` — Angular application implementation guidance and coding standards
  - Skill: `skills/angular/SKILL.md`
  - Handbook: `skills/angular/HANDBOOK.md`
...
- `repo-audit` — Top-level repository audit orchestrator for Angular, .NET, Checkmarx, and SonarQube checks
...
- Put longer guidance in `HANDBOOK.md` when a skill needs it
