---
name: sonarqube-scan
description: Use when you need an authenticated SonarQube quality-gate and issue summary for a repository using the local sonar CLI after CI has run an analysis.
---
